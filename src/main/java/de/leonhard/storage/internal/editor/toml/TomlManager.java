 ...
 * Rewritten by JavaFactoryDev for LighntingStorage.
 */
@UtilityClass
public class TomlManager {
	 ...
	 */
	public String writeToString(Map<String, Object> data) throws IOException {
	 ...
	 * @throws IOException if an error occurs
	 */
	public void write(Map<String, Object> data, File file) throws IOException {
	 ...
	 */
	public void write(Map<String, Object> data, OutputStream out) throws IOException {
	 ...
	 * @throws TomlException if a parse error occurs
	 */
	public void write(Map<String, Object> data, Writer writer) throws IOException {
	 ...
	 * @throws TomlException if a parse error occurs
	 */
	public void write(Map<String, Object> data, Writer writer, int indentSize, boolean indentWithSpaces) throws IOException {
	...
	/**
	 * Reads a String that contains TOML data. Lenient bare keys are allowed (see {@link TomlManager}).
	 *
	 * @param toml a String containing TOML data
	 * @return a {@code Map<String, Object>} containing the parsed data
	 * @throws TomlException if a parse error occurs
	 */
	public Map<String, Object> read(String toml) throws TomlException {
	 ...
	 *
	 * @param toml                a String containing TOML data
	 * @param strictAsciiBareKeys <code>true</code> to enforce strict bare keys (see {@link TomlManager}).
	 * @return a {@code Map<String, Object>} containing the parsed data
	 * @throws TomlException if a parse error occurs
	 */
	public Map<String, Object> read(String toml, boolean strictAsciiBareKeys) {
		TomlReader tr = new TomlReader(toml, strictAsciiBareKeys);
		return tr.read();
	}

	/**
	 * Reads TOML data from an UTF-8 encoded File. Lenient bare keys are allowed (see {@link TomlManager}).
	 *
	 ...
	 * @throws TomlException if a parse error occurs
	 */
	public Map<String, Object> read(File file) throws IOException, TomlException {
	 ...
	 * @throws TomlException if a parse error occurs
	 */
	public Map<String, Object> read(File file, boolean strictAsciiBareKeys) throws IOException, TomlException {
		return read(new FileInputStream(file), strictAsciiBareKeys);
	}

	/**
	 * Reads TOML data from an UTF-8 encoded InputStream. Lenient bare keys are allowed (see {@link TomlManager}).
	 *
	 ...
	 * @throws TomlException if a parse error occurs
	 */
	public Map<String, Object> read(InputStream in) throws IOException, TomlException {
	 ...
	 * @throws TomlException if a parse error occurs
	 */
	public Map<String, Object> read(InputStream in, boolean strictAsciiBareKeys) throws IOException, TomlException {
	 ...
	 * @throws TomlException if a parse error occurs
	 */
	public Map<String, Object> read(Reader reader, int bufferSize, boolean strictAsciiBareKeys) throws IOException, TomlException {
