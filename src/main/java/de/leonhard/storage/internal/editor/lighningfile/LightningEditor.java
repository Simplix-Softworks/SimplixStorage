        ...
        try {
            ...
            while (lines.size() > 0) {
                ...
                if (tempLine.contains("}")) {
                    throw new LightningFileException("Error at '" + file.getAbsolutePath() + "' -> Block closed without being opened");
                    ...
                    if (!tempLine.equals("{")) {
                        ...
                        throw new LightningFileException("Error at '" + file.getAbsolutePath() + "' -> Key must not be null");
                    }
                    ...
                    if (tempLine.contains("=")) {
                        ...
                        if (lines.get(1).contains("{")) {
                            ...
                            throw new LightningFileException("Error at '" + file.getAbsolutePath() + "' -> '" + tempLine + "' does not contain value or subblock");
                        }
                    }
                }
            }
            ...
            if (tempLine.equals("}")) {
                ...
                if (tempLine.contains("=")) {
                    ...
                    if (lines.get(1).contains("{")) {
                        ...
                        throw new LightningFileException("Error at '" + filePath + "' -> '" + tempLine + "' does not contain value or subblock");
                    }
                }
            }
        }
