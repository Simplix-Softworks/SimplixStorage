...
public class LightningUtils {
	 ...
	 */
	@SuppressWarnings("DuplicatedCode")
	public static Map<String, Object> setHeader(final @NotNull FileData fileData, final @NotNull String key, final @Nullable List<String> header, final @NotNull DataType dataType, final @NotNull Comment commentSetting) {
	 ...
	 */
	@SuppressWarnings("DuplicatedCode")
	public static Map<String, Object> setFooter(final @NotNull FileData fileData, final @Nullable List<String> footer, final @NotNull DataType dataType, final @NotNull Comment commentSetting) {
		Map<String, Object> tempMap = fileData.toMap();
	 ...
	 */
	@SuppressWarnings("DuplicatedCode")
	public static Map<String, Object> setFooter(final @NotNull FileData fileData, final @NotNull String key, final @Nullable List<String> footer, final @NotNull DataType dataType, final @NotNull Comment commentSetting) {
		if (fileData.get(key) instanceof Map) {
			//noinspection unchecked
			Map<String, Object> tempMap = (Map<String, Object>) fileData.get(key);
			List<String> keyList = new ArrayList<>(tempMap.keySet());
