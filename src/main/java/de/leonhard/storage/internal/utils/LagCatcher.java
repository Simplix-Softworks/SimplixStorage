...
public class LagCatcher {
	...
	public static final void start(final String name) {
	...
	public static final void stop(final String name) {
	...
	public static final void stopAndShow(final String name) {
		stop(name);
		show(name);
	}

	public static final void runMultipleTimes(final int cycles, final Runnable runnable) {
		long nanosTook = 0L;
