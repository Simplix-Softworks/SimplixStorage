...
class CSV extends StorageCreator implements StorageBase {
	 ...
	 *
	 * @param key
	 *            The key your value should be associated with
	 * @param value
	 *            The value you want to set in your file
	 */
	@Override
